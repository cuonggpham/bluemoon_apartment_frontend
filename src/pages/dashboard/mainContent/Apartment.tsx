    ...
    <PageContainer ref={containerRef}>
      <HeaderSection ref={headerRef}>
        <Row type="horizontal" justify="between" gap="lg">
          <div>
            <StyledHeading as="h1">Apartments Management</StyledHeading>
            <Description>Manage apartments, owners, and property details</Description>
          </div>
          <AddAndSearch title="Add Apartment" setKeyword={setKeyword} keyword={keyword}>
            <ApartmentForm />
          </AddAndSearch>
        </Row>
      </HeaderSection>
